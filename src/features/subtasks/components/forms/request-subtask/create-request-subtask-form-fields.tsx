...
export const RequestsFields = ({ fieldNames }: Props) => {
    const {fields: fieldsArray, append, remove, update} = useFieldArray({
        ...
        <div>
            <div>
                {fieldsArray.map((field, index) => (
                    <div key={field.id}>
                        <DynamicFormField fieldName={`${fieldNames.requests.fieldName}.${index}.${fieldNames.requests.fields.endpoint}`} />
                        <DynamicFormField fieldName={`${fieldNames.requests.fieldName}.${index}.${fieldNames.requests.fields.requestType}`} />
                        <DynamicFormField fieldName={`${fieldNames.requests.fieldName}.${index}.${fieldNames.requests.fields.paginated}`} />
