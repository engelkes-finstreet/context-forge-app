...
export async function createPageSubtaskFormAction(
  state: FormState,
  formData: CreatePageSubtaskFormInput,
): Promise<FormState> {
...
export async function updatePageSubtaskFormAction(
  state: FormState,
  formData: UpdatePageSubtaskFormInput,
): Promise<FormState> {
