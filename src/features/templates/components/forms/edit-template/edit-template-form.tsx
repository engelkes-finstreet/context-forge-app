...
import { editTemplateFormAction } from "./edit-template-form-action";
import { getTypeConfig } from "@/features/subtasks/config/type-config";
import { Trash2, Plus, GripVertical } from "lucide-react";
import { SubtaskTemplateInput } from "../create-template/create-template-form-schema";
...
export function EditTemplateForm({
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const result = await editTemplateFormAction(
